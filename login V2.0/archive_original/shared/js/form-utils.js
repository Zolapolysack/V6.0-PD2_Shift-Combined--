// Archived original: Shared Form Utilities
// Moved from ../../shared/js/form-utils.js
class FormUtils {
    ...
    static showNotification(message, type = 'info', container = null) {
        ...
        // Create notification element without inline styles
        const notification = document.createElement('div');
        notification.className = 'notification';
        if (type === 'error') notification.classList.add('is-error');
        else if (type === 'success') notification.classList.add('is-success');
        ...
        // Remove notification after 3 seconds with CSS class hook
        setTimeout(() => {
